...
export default function Login() {
  ...
  const validateForm = (values) => {
    ...
    if (!values.email.trim()) {
      ...
      errors.email = "Invalid email address. Missing top-level domain (e.g., .com, .net)";
    }
              ...
              <div className="g-0 lg:flex lg:flex-wrap">
                  ...
                  <div className="md:mx-6 md:p-12">
                    ...
                    <form onChange={handleSubmit}>
                      ...
                      <div className="flex items-center justify-between pb-6">
                        <Link to="/login" className="mb-0 mr-2">Do you  have account ? </Link>
                ...
                >
                  <div className="px-4 py-6 text-white md:mx-6 md:p-12">
                    ...
                    <p className="text-sm">
                      Welcome to OctoList, your ultimate guide to organizing your octopus-themed tasks! Dive into a world
                    </p>
                  </div>
                </div>
              </div>
